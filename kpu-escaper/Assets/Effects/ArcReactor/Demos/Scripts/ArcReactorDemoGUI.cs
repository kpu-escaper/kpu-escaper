...
public class ArcReactorDemoGUI : MonoBehaviour {
	...
	void OnGUI () 
	{
		...
		GUI.Label (new Rect (Screen.width-240,Screen.height-140,230,20), "Press 1,2,3,4,5,6,7 to change weapon effect.");
		GUI.Label (new Rect (Screen.width-240,Screen.height-110,230,20), "Press Q to toggle showcase.");
